...
class CharacterHolders(BaseModel):
    wallet_address: str = Field(
        "", example="0x3CCcF9DFaC3D0Ff6A20aD2a6396fE8119b10A92e"
    )
...
class CharacterMemoryData:
    ...
    contract_address: str = Field(
        "", exmple="0x579cB2931869Ea158Bcd7b7823a3a0c543486b93"
    )
    contract_id: int = Field(-1, exmple=100)
    linked_nft_contract_address: str = Field(
        "", exmple="0x579cB2931869Ea158Bcd7b7823a3a0c543400000"
    )
